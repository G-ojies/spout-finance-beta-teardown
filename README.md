...
| C9 | AAPL list price vs ticket | List and ticket both show **$228.50** (the hardcoded fallback); AAPL is appended last in the list, after XOM | `12-aapl-purchase-confirmed-228.png` |
